...
const posts = [
    ...
    },
    {
        ...
        content: [
            {
                type: "paragraph",
                text: "What do we mean when we talk about creating a circular economy? A circular economy, by design, is supposed to be regenerative. All the components that are part of this economy flow alongside each other in a closed loop-like system, and are not meant to be used once and discarded. "
            },
            {
                type: "paragraph",
                text: "Now, can you imagine what would happen if we could make plastic a part of this circular economy? Globally to date, there are approximately 8.3 billion tons of plastic in the world, and almost 6.3 billion of that is garbage. In the light of this data, wouldn’t it be great if we could collectively figure out ways to recover value from the plastic, without causing damage to the environment?"
            },
            {
                type: "paragraph",
                text: "According to a report by the Ellen MacArthur Foundation, only 14% of the plastic packaging used globally is recycled, 40% ends up in landfills, and 32% in the rest of the ecosystem. We all know about the three Rs (reduce, reuse, recycle), but are yet to implement them in a way that benefits all stakeholders. Do a fundamental rethink about plastic reuse, and you will realise that it is possible to not only improve recycling and reuse, but also create a robust market for recycled and redesigned plastic products."
            },
            {
                type: "paragraph",
                text: "Currently, poorly designed markets for recycled plastics act as the biggest deterrent to creating a circular economy for plastics. While many organisations are making recyclability their priority, only a handful are thinking about their role in creating demand for recycled plastic products. The other barrier to achieving plastics circularity is that manufacturers of plastic have no incentive to to consider end-of-life use throughout the development process. If they did, these manufacturers would then easily be able to customise plastic to meet specific requirements, and ensure they can be repurposed at the end of their initial use, and also simplify the recycling processes."
            },
            {
                type: "paragraph",
            ...
            {
                type: "paragraph",
                text: "Creating a circular economy for plastics offers a promising outlook for the world in terms of stemming the tidal wave of plastic waste. Once we ensure greater cooperation and coordination from all stakeholders in the value chain, it will become much easier to fulfill the vision of a no-garbage world."
            }
        ]
    },
    {
